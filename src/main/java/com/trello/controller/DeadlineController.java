...
import com.trello.model.Deadline;
import com.trello.model.dto.DeadlineDto;
import com.trello.model.request.DeadlineRequest;
import com.trello.repository.DeadlineRepository;
...
public class DeadlineController {
    ...
    public ResponseEntity<?> getDeadline(@RequestParam("taskId") Long taskId) {
        if (deadlineRepository.getByTaskId(taskId) != null) {
